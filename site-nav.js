...
(function () {
  ...
  var CSS = [
    ...
    'border-bottom:1px solid var(--swdnav-line);font-family:var(--swdnav-font);}',
    '#swd-site-header *{box-sizing:border-box;}',
    '.swdnav-bar{max-width:1560px;margin:0 auto;padding:0 22px;display:flex;',
    ...
    '.swdnav>ul{list-style:none;display:flex;flex-wrap:nowrap;justify-content:flex-end;',
    'gap:0;margin:0;padding:0;align-items:center;}',
    '.swdnav li{position:relative;}',
    '.swdnav li.open{z-index:20;}',
    '.swdnav a,.swdnav button{display:block;padding:8px 9px;font-size:12.5px;font-weight:500;',
    ...
    '.swdnav button::after{content:"";display:inline-block;margin-left:5px;',
    ...
    'border-radius:10px;box-shadow:0 12px 32px -12px rgba(15,23,42,.28);display:none;z-index:20;}',
    ...
    '@media(max-width:1250px){.swdnav-toggle{display:block;}',
    ...
    '.swdnav>ul{flex-direction:column;align-items:stretch;gap:0;flex-wrap:wrap;}',
    ...
    'padding:34px 0 26px;margin-top:48px;font-size:.9rem;font-family:var(--swdnav-font);}',
    '#swd-site-footer .in{max-width:1560px;margin:0 auto;padding:0 22px;display:flex;',
